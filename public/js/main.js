...
/* end copied and pasted in */

/* Invite: send an invite message to the server */
...
/* Uninvite: send an uninvite message to the server */
...
/*  handle a response after sending an uninvite response to the server  */
...
/* game start: send an game start message to the server */
...
socket.on('game_update',function(payload){
	...
	if(socket.id == payload.game.player_white.socket){
		my_color = 'white';
			...
			/* something weird is going on, like a third player */
	...
	$('#my_color').html('<div id="my_color">your game color: '+my_color+'</br>player up: '+payload.game.whose_turn+'</br>player\'s name: ' +username+'</br>');
	$('#my_color').append('<div class="text-left">elapsed time: <span id="elapsed"></span></div></div>');
...
socket.on('game_over', function(payload){
	...
	$('#game_over').append('<a href="lobby.html?username='+username+'" class="btn btn-success btn-lrg active" role="button" aria-pressed="true">Return to the lobby</a>');
